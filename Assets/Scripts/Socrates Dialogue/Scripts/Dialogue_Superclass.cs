...
public class DialogueSuperclass : MonoBehaviour {
    public interface DialogueSection {
        ...
        void SetNext(DialogueSection next);
    }
    ...
    public class Monologue : DialogueSection {
        ...
        readonly string dialogueSound;

        // If there is no next, terminate
        readonly Action action;
        readonly bool triggerActionWhenStart;
        readonly bool isMonotone;
        readonly float charDelay;
        ...
        public void SetNext(DialogueSection next) {
            this.next = next;
        }
    }
    ...
    public class Choices : DialogueSection {
        ...
        public readonly List<Tuple<string, DialogueSection>> choices;
